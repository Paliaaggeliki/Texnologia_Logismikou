...
def display_info():
    ...
    st.write("""
        Η εφαρμογή αναπτύχθηκε από την ομάδα μας:
        - Μέλος Παλιά Αγγελική: Ανάπτυξη και ενσωμάτωση της λειτουργικότητας φόρτωσης και προεπεξεργασίας δεδομένων.
                                Ανάπτυξη της λειτουργικότητας οπτικοποίησης δεδομένων και EDA
        - Μέλος Κουτλή Ιφιγένεια: Ανάπτυξη της λειτουργικότητας ταξινόμησης και αξιολόγησης αλγορίθμων.
                                  Σχεδίαση και τεκμηρίωση της εφαρμογής
        - Μέλος Κουκόση Παρασκευή-Ειρήνη: Ανάπτυξη της λειτουργικότητας συσταδοποίησης και παρουσίασης των αποτελεσμάτων.
                                          Σχεδίαση και τεκμηρίωση της εφαρμογής
    """)  
